...
Rails.application.config.assets.paths << Rails.root.join('vendor', 'bootstrap2')
Rails.application.config.assets.paths << Rails.root.join('vendor', 'bootstrap2', 'bootstrap')
